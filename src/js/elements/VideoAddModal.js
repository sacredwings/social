...
class VideoAddModal extends Component {
    ...
    render() {
        return (
            ...
            <div className="modal fade" id="modalVideoAdd" tabIndex="-1" aria-labelledby="modalVideoAdd" aria-hidden="true">
                    ...
                    <div className="modal-content">
                        <form onSubmit={this.onFormSubmitFile}>
                            <div className="modal-header">
                                <h5 className="modal-title" id="exampleModalLabel">Добавь видео в альбом</h5>
